...
<head>
    <meta charset="UTF-8">
    <title>Dashboard Peralatan Tanggap Darurat UP2WV - APAT</title>
...
<div id="modal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center hidden z-50">
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md relative">
        ...
        <form action="{{ route('apat.store') }}" method="POST">
            @csrf
            <div class="mb-3"><label class="block font-semibold">ID APAT</label><input type="text" name="id_apat" required class="w-full px-3 py-2 border rounded" placeholder="cth: A1.01"></div>
